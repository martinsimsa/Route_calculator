...
This is technical documentation for Route Calculator. See the list of classes, functions and global variables. For description how everything works, see the description of the main() function. 
...
## Classes
This is a list of classes and structures of Route Calculator program:

### Seznam tříd:
Program obsahuje následující třídy:
 - cmp_str - porovnávání const char*
 - Comparator - porovnávání objektů třídy Node
 - Node - body na grafu - 2D čtvercová síť
 - Object - objekty zakreslené na .omap mapě



### struct cmp_str
 - This is a struct with comparison function used for comparing keys in maps that use const char* as a key.

### struct Comparator
 - This is a struct for comparing Node objects in the queue in A* algorithm

### class Node
Objects of this class are nodes in the 2D grid which corresponds to our map. 
#### Attributes:
 - g - That is the "distance" of the node from the start in A* algorithm
...
## Functions
This is the list of functions of the Route Calculator program.
...
void <span style="color:yellow">import_grid </span>(Node***& grid, std::string path, int* grid_dimensions) {
 ...
 This part describes the main function and the steps of the Route Calculator program.
